# @youwol/flux-dataframe


Collection of modules for Flux to create & manipulate data-frames
...
You can find the documentation [here](https://youwol.github.io/$flux-dataframe/dist/docs/index.html).
